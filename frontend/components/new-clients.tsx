    ...
    return (
        <Card className="bg-card border-border">
            <CardHeader className="flex flex-row items-center justify-between">
                <CardTitle className="text-lg font-semibold text-card-foreground">New Clients</CardTitle>
            ...
            <CardContent className="space-y-4">
                {treatments.map((treatment, index) => {
                    ...
                    return (
                        <div key={index} className="flex items-center justify-between p-1 rounded-lg bg-muted/50">
